<template>
  <div
    id="container"
    class="flex flex-col items-center rounded-lg p-4 w-[15rem] h-[20rem] shadow-standart bg-container hover:bg-sec transition-all cursor-pointer"
  >
    <font-awesome-icon
    ...
    <div id="infoContainer" class="flex flex-col w-full mt-4">
      ...
      <div class="flex flex-col w-full mt-4 gap-1">
        ...
        <textarea
          ...
          class="outline-none bg-text/10 cursor-pointer rounded-md w-full h-[5rem] resize-none p-3 py-1"
        ></textarea>
      </div>
    </div>
  </div>
